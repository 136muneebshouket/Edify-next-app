          ...
          <div className="web-cards">
            <div className="web-singlecards-one">
              ...
              <div class="pricing_content">
                <ul>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Application Development</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Application support and Maintenance</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Document Management</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Off Shoring</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Mobile Application Development</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Enterprise Development terminals</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Cloud Services</strong></span></li>
            ...
            <div className="web-singlecards-two">
              ...
              <div class="pricing_content">
                ...
                <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Application Development</strong></span></li>
                  ...
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>High level requirements</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Responsive</strong></span></li>
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Social Media Integration</strong></span></li>
                </ul>
              </div>
              <div className="buynow-btn">
            ...
            <div className="web-singlecards-three">
              ...
              <div class="pricing_content">
                ...
                <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Application Development</strong></span></li>
                  ...
                  <li><span style={{ color: "#000000", fontSize: "14px" }}><strong>Risk assesment</strong></span></li>
